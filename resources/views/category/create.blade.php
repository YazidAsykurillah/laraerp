...
@section('page_header')
  <h1>
    Category Product
    <small>Add New Category Product</small>
  </h1>
@endsection
...
@section('content')
  <div class="row">
    {!! Form::open(['route'=>'category.store','role'=>'form','class'=>'form-horizontal', 'files'=>true]) !!}
      <div class="col-md-9">
        <div class="box" style="box-shadow:0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);border-top:none">
          ...
          <div class="box-body">
            <div class="form-group{{ $errors->has('code') ? ' has-error' : '' }}">
              ...
              <div class="col-sm-10">
                {!! Form::text('code',$code_fix,['class'=>'form-control', 'placeholder'=>'Code of the category', 'id'=>'code', 'readonly']) !!}
                @if ($errors->has('code'))
