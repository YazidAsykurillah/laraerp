...
@section('breadcrumb')
  <ol class="breadcrumb">
    ...
    <li><a href="{{ URL::to('customer/'.$customer->id.'/payment-invoices') }}"><i class="fa fa-dashboard"></i>{{ $customer->code}}</a></li>
                    ...
                    <div class="box" style="box-shadow:0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);border-top:none">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group{{ $errors->has('sum_amount') ? ' has-error' : '' }}">
                              {!! Form::label('sum_amount', 'Total Amount', ['class'=>'col-sm-2 control-label']) !!}
                              <div class="col-sm-4">
                                {!! Form::text('sum_amount', null,['class'=>'form-control', 'placeholder'=>'Total Amount', 'id'=>'sum-amount-giro']) !!}
                                @if ($errors->has('sum_amount'))
                                  <span class="help-block">
                                    <strong>{{ $errors->first('sum_amount') }}</strong>
                                  </span>
                            ...
                            <div class="form-group{{ $errors->has('gir_account') ? ' has-error' : '' }}">
                                {!! Form::label('gir_account','Cash/Bank Account',['class'=>'col-sm-2 control-label']) !!}
                                <div class="col-sm-4">
