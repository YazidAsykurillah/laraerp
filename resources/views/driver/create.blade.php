...
@section('page_header')
  <h1>
    Add New Driver
    <small>Add New Driver Page</small>
  </h1>
@endsection
      ...
      <div class="box">
        ...
        <div class="box-body">
          ...
          <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
            ...
            <div class="col-sm-10">
              {!! Form::text('name','Aman',['class'=>'form-control', 'placeholder'=>'Name of the driver', 'id'=>'name']) !!}
              @if ($errors->has('name'))
                <span class="help-block">
      ...
      <div class="box">
        ...
        <div class="box-body">
          ...
          <div class="form-group{{ $errors->has('primary_phone_number') ? ' has-error' : '' }}">
            ...
            <div class="col-sm-10">
              {!! Form::text('primary_phone_number',null,['class'=>'form-control', 'placeholder'=>'Primary phone of the driver', 'id'=>'primary_phone_number']) !!}
