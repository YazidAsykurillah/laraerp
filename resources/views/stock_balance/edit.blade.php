...
@section('content')
  <!-- Row Products-->
  {!! Form::model($stock_balance, ['route'=>['stock-balance.update', $stock_balance->id], 'id'=>'form-edit-stock-balance', 'class'=>'form-horizontal','method'=>'put', 'files'=>true]) !!}
  <div class="row">
    <div class="col-lg-12">
      <div class="box">
        ...
        <div class="box-body">
          <div class="table-responsive">
            <table class="table table-bordered" id="table-selected-products">
              ...
              <tbody>
                @if($stock_balance->products->count() > 0)
                  @foreach($stock_balance->products as $product)
                  <tr id="tr_stock_balance_{{$product->id}}">
                    <td>
